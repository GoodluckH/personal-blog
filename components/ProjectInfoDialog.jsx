...
export default function ProjectInfoDialog({ isOpen, project = {}, onClose }) {
  ...
  return (
    <Dialog
      open={isOpen}
      onClose={onClose}
      className="fixed z-20 inset-0 overflow-y-visible"
    >
      <div className="flex items-center justify-center min-h-screen">
        ...
        />
        <div className="ml-[-2px] mr-8">
          <div className="bg-white dark:bg-gray-700 shadow-2xl rounded-lg max-w-xl mx-auto z-30 overflow-hidden w-full relative mx-4">
            <button
              ...
              <div className="border-t mt-4 pt-4 dark:border-gray-600">
                <div className="flex flex-wrap">
                  {project.stack?.map((item) => (
                    <span
                      key={item}
                      className="px-2 py-1 mr-1.5 mb-1.5 font-medium text-gray-700 dark:text-white dark:border-gray-500 text-xs border rounded-full"
                    >
                      {item}
                    </span>
                  ))}
